...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "qdfxn82a2r6sjgxd075p3d3gzyyekndnajs3uq9ynfjwkf5uu30h",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "media player"),
        command = .myCommand
    ...
    metadata = (
      ...
      icons = (
        ...
        #appGrid = (png = embed "/opt/app/images/ampache-logo.png"),
        #grain = (png = embed "~/images/ampache-logo.png"),
        #market = (png = embed "~/images/ampache-logo.png"),
        #marketBig = (png = embed "~/images/ampache-logo.png"),
      ),

      website = "http://ampache.org/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/paulproteus/ampache-sandstorm-prototype",
      ...
      author = (
        ...
        contactEmail = "aminah.nuraini92@gmail.com",
      ...
      description = (defaultText = embed "../docs/description.md"),
      # The app's description in Github-flavored Markdown format, to be displayed e.g.
      # in an app store. Note that the Markdown is not permitted to contain HTML nor image tags (but
      # you can include a list of screenshots separately).

      shortDescription = (defaultText = "Media Player"),
      ...
      screenshots = [
        ...
        (width = 1651, height = 536, jpeg = embed "../images/preview/catalog.jpg"),
        #(width = 1585, height = 841, jpeg = embed "D:\xampp\htdocs\PHP projects\Asheesh Laroia\ampache-sandstorm-prototype\images\preview\artist.jpg"),
        #(width = 1591, height = 841, jpeg = embed "D:\xampp\htdocs\PHP projects\Asheesh Laroia\ampache-sandstorm-prototype\images\preview\playing.jpg"),
        #(width = 1590, height = 840, jpeg = embed "D:\xampp\htdocs\PHP projects\Asheesh Laroia\ampache-sandstorm-prototype\images\preview\album_edit.jpg"),
        #(width = 1879, height = 912, jpeg = embed "D:\xampp\htdocs\PHP projects\Asheesh Laroia\ampache-sandstorm-prototype\images\preview\visualizer.jpg"),
      ],
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "", "--", "/opt/app/.sandstorm/launcher.sh"],
  environ = [
